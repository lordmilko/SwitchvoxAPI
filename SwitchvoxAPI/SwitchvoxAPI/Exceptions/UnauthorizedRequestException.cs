...
{
    /// <summary>
    /// The exception that is thrown when a <see cref="SwitchvoxResponse"/> fails with a <see cref="System.Net.WebException"/> with StatusCode <see cref="System.Net.HttpStatusCode.Forbidden"/>/>.
    /// </summary>
    [Serializable]
